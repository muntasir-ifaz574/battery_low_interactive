...
import 'package:batterylow/src/views/ui/welcome.dart';
...
class BaseAPICaller {
  ...
  static void moveToLogin() async {
    ...
    Navigator.pushAndRemoveUntil(MyApp.navigatorKey.currentState!.context, MaterialPageRoute(builder: (context) => const Welcome()), (route) => false);
  }
}